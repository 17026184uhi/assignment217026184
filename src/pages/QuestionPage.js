          ...
          <div className="p-3 mb-2 bg-light">
            <div className="text-center">
              <img
                ...
                src="https://firebasestorage.googleapis.com/v0/b/iwtse-1928f.appspot.com/o/balances.png?alt=media&amp;token=dd2d8d20-7257-4ec2-985a-33dd38939e9b"
              />
            </div>
            <p>
              Three balances are supported on rigid pivots and connected by two
              flexible light strings as shown in the diagram above. Note that...
            </p>
          </div>
        </div>
        <div className="col-sm">
